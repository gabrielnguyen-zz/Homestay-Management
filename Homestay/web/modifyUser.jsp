                ...
                <div class="container">
                    <div class="row slider-text align-items-end">
                        <div class="col-md-10 col-sm-12 ftco-animate mb-4">
                            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span> <span>Search User</span></p>
                            <h1 class="mb-3">Search User</h1>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-8 ftco-animate">
                        <div class="pt-5 mt-5">
                            <div class="comment-form-wrap pt-5">
                                <h3 class="mb-5">Search User By Name</h3>
                                <input type="text" name="txtSearchUser" value="" class="form-control"/><br/>
                                <input type="submit" value="Search User" name="action" class="btn btn-primary">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <table class="table">
                        ...
                        <form action="MainController" method="POST">
                            <tr>
                                ...
                                <td>
                                    <button class="btn btn-primary" type="submit" value="Delete User" name="action">Delete User</button>
                                    <input type="hidden" name="txtSearchUser" value="<%= request.getParameter("txtSearchUser") %>" />
