...
<%@page import="nguyen.models.ServiceDTO"%>
                ...
                <div class="container">
                    <div class="row slider-text align-items-end">
                        <div class="col-md-10 col-sm-12 ftco-animate mb-4">
                            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span> <span>Choose your service</span></p>
                            <h1 class="mb-3">Choose your service</h1>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container bg-light">
                <div class="row d-flex mb-5 contact-info">
                    <div class="col-md-12 mb-4">
                        <h2>If you want any service, please choose a quantity to make your order</h2><br/>
                        <h4>Make sure everything or you have to do it all again!!!!</h4>
                ...
                <div class="cart_inner">
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                                <%
                                    List<ServiceDTO> result = (List<ServiceDTO>) request.getAttribute("SERVICE");
                            ...
                            <form action="MainController" method="POST">
                                <tr>
                                    ...
                                    <td>
                                        <%= dto.getServiceName()%>
                                        <input type="hidden" name="serviceName" value="<%= dto.getServiceName()%>" />
                                        <input type="hidden" name="serviceID" value="<%= dto.getServiceID()%>" />
                                    </td>
                                    <td>
                                        <%= dto.getPrice()%>
                                         <input type="hidden" name="servicePrice" value="<%= dto.getPrice()%>" />
                                    </td>
                                    <td>
                                        <input type="number" name="serviceQuantity" value="1" />
                                    </td>
                                    <td>
                                        <input type="submit" value="Add to Cart" class="btn btn-primary" name="action" />
                                        <input type="hidden" name="cart" value=" <%= shoppingCart %>" />
                                        <input type="hidden" name="txtRoomID" value="<%= request.getParameter("txtRoomID") %>" />
                                        <input type="hidden" name="roomQuantity" value="<%= session.getAttribute("ROOMQUANTITY")%>" />
                                    </td>
                            ...
                            %>
                             ...
                             <a href="checkOut.jsp" class="btn btn-primary" >Click to continue</a>
                    </div>
                </div>
            </div>
        </section>
