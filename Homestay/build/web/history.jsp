                ...
                <div class="cart_inner">
                    <div class="table-responsive">
                        <table class="table">
                            <thead>
                                <%
                                    InvoiceDTO result =(InvoiceDTO) request.getAttribute("HISTORY");
                                    if(result!=null){ %> 
                                <tr>
                                    <th>Invoice ID</th>
                                    <th>Room Name</th>
                            ...
                            <form action="MainController" method="POST">
                                <tr>
                                    ...
                                    <td>
                                        $<%= result.getServicePrice() %>
                                    </td>
                                    <td>
                                        <%= result.getServiceQuantity()%>
                                    </td>
                                    <td>
                                        $<%=(result.getRoomPrice() * result.getRoomQuantity()) + (result.getServicePrice() * result.getServiceQuantity())%>
