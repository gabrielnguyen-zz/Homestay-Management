...
<%@page import="nguyen.models.StaffDTO"%>
...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
            <div class="container">
                <a class="navbar-brand" href="admin.jsp">LÀ NHÀ</a>
                ...
                <div class="collapse navbar-collapse" id="ftco-nav">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item "><a href="test.jsp" class="nav-link">View Invoice</a></li>
                        <li class="nav-item "><a href="modifyUser.jsp" class="nav-link">Manage User</a></li>
                        <li class="nav-item"><a href="admin.jsp" class="nav-link">Manage Staff</a></li>
                ...
                <div class="container">
                    <div class="row slider-text align-items-end">
                        <div class="col-md-10 col-sm-12 ftco-animate mb-4">
                            <p class="breadcrumbs"><span class="mr-2"><a href="index.html">Home</a></span> <span>Search Staff</span></p>
                            <h1 class="mb-3">Search Staff</h1>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-8 ftco-animate">
                        <div class="pt-5 mt-5">
                            <div class="comment-form-wrap pt-5">
                                <h3 class="mb-5">Search Your Staff By Name</h3>
                                <input type="text" name="txtSearchStaff" value="" class="form-control"/><br/>
                                <input type="submit" value="Search Staff" name="action" class="btn btn-primary">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="cart_inner">
                <div class="table-responsive">
                    <table class="table">
                        <thead>
                            <%
                                List<StaffDTO> result = (List<StaffDTO>) request.getAttribute("INFO");
                                if (result != null) {
                                    if (result.size() > 0) {
                            %> 
                            <tr>
                        ...
                        <form action="MainController" method="POST">
                            <tr>
                                ...
                                <td>
                                    <%= dto.getAccount() %>
                                    <input type="hidden" name="accountName" value="<%= dto.getAccount() %>" />
                                </td>
                                <td>
                                     ****
                                </td>
                                <td>
                                    <input type="text" value="<%= dto.getFullName() %>" name ="fullName">
                                </td>
                                
                                <td>
                                    <button class="btn btn-primary" type="submit" value="Update" name="action">Update</button>
                                    <input type="hidden" name="txtSearchStaff" value="<%= request.getParameter("txtSearchStaff") %>" />
                                </td>
                                <td>
                                    <button class="btn btn-primary" type="submit" value="Delete" name="action">Delete</button>
                                    <input type="hidden" name="txtSearchStaff" value="<%= request.getParameter("txtSearchStaff") %>" />
